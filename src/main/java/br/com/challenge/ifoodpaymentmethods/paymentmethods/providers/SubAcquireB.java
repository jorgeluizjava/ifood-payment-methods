...
import br.com.challenge.ifoodpaymentmethods.paymentmethods.process.online.SubAcquirerBProcessPayment;
...
public class SubAcquireB implements Provider {
    ...
    public SubAcquireB(@NotNull ProviderConfiguration providerConfiguration, RestTemplate client) {
    ...
    public Optional<ProcessPayment> accept(PaymentRequest paymentRequest) {
        ...
        return Optional.of(new SubAcquirerBProcessPayment(client));
    }
}
