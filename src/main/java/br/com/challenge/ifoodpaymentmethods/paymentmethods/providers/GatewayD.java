...
import br.com.challenge.ifoodpaymentmethods.paymentmethods.process.online.GatewayDProcessPayment;
...
public class GatewayD implements Provider {
    ...
    public GatewayD(@NotNull ProviderConfiguration providerConfiguration, RestTemplate client) {
    ...
    public Optional<ProcessPayment> accept(PaymentRequest paymentRequest) {
        ...
        return Optional.of(new GatewayDProcessPayment(client));
    }
}
